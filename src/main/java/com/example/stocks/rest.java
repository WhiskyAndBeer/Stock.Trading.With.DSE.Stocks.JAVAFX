...
//        String url = "https://www.dsebd.org/displayCompany.php?name=GP";
        ...
        try {
            for (String company : companies) {
                ...
                Document doc = Jsoup.connect(url+company).get();
                ...
                System.out.println("Day's Range: " + daysRange);
                System.out.println("Change Value: " + changeValue);
                System.out.println("Change Percent: " + changePercent);
                System.out.println("Day's Value (mn): " + daysValue);
                System.out.println("52 Weeks' Moving Range: " + weeksMovingRange);
                System.out.println("Opening Price: " + openingPrice);
                System.out.println("Day's Volume: " + daysVolume);
                System.out.println("Adjusted Opening Price: " + adjustedOpeningPrice);
                System.out.println("Day's Trade: " + daysTrade);
                System.out.println("Yesterday's Closing Price: " + yesterdaysClosingPrice);
                System.out.println("Market Capitalization (mn): " + marketCapitalization);
            }
